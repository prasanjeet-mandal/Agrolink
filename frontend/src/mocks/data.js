...
export const chatbotKnowledge = [
  ...
  // ---- Demo / support ----
  { en: { q: 'How do I log in to try the demo?', a: 'Use the seeded demo accounts: consumer at meera@example.com, farmer at harpreet@example.com, and FPO at fpo.punjab@example.com — all with password "secret". The landing page footer also has a quick sign-in shortcut.' }, hi: { q: 'डेमो आज़माने के लिए कैसे लॉगिन करूं?', a: 'डेमो अकाउंट: कंज्यूमर meera@example.com, फार्मर harpreet@example.com, FPO fpo.punjab@example.com — सभी का पासवर्ड secret है।' }, pa: { q: 'ਡੈਮੋ ਲਈ ਕਿਵੇਂ ਲੌਗਇਨ ਕਰਾਂ?', a: 'meera@example.com (ਖਪਤਕਾਰ), harpreet@example.com (ਕਿਸਾਨ), fpo.punjab@example.com (FPO) — ਪਾਸਵਰਡ secret।' }, mr: { q: 'डेमो साठी लॉगिन कसे करू?', a: 'meera@example.com (ग्राहक), harpreet@example.com (शेतकरी), fpo.punjab@example.com (FPO) — पासवर्ड secret.' }, ta: { q: 'டெமோ லாகின் எப்படி?', a: 'meera@example.com, harpreet@example.com, fpo.punjab@example.com — கடவுச்சொல் secret.' } },
